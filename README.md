...
- Secure NGINX with support for very latest improvements like HTTP2 with ALPN, 0-RTT support for TLS 1.3, TLS 1.3
  support, x25519 support, etc.
...
The technologies used depend on what KVS supports, which means that some may not be the most up-to-date if KVS has not
yet provided support for them.
